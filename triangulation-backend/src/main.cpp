...
int main(int argc, char *argv[])
{
    ...
    std::vector<Point> testCaseInner {
        ...
        Point(11.25, 4.5), Point(18.75, 9.5), Point(18.75, 4.5),
        Point(11.25, 9.5), Point(11.25, 7), Point(18.75, 7) };

    std::vector<Point> testLargeRect {
        Point(540, 540), Point(720, 540), Point(900, 540),
        Point(900, 420), Point(900, 300), Point(720, 300),
        Point(540, 300), Point(540, 420)};
